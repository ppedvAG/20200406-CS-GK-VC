...
namespace Demo_Delegate
{
    ...
    {
        #region Step1
        //Beispielmethoden zur Demonstration von Delegaten
        ...
        #region Callbacks in C# way step 1
...

        {
            ...
            //KOnstruktor des Delegaten erwartet eine Methode, die genausoviele Parameter annimmt
            //wie bei der Deklaration des Delegaten angegeben wurden
          ...
          //Delegate wird über Delegate ausgeführt
            ...
            Console.WriteLine("### LISTS & DELEGATS ###");
           ...
           // Ausführliche Syntax der Pfeilfunktion
            ...
            // Wenn in der Funktion nur eine Anweisung ausgeführt wird, dann ist return 
            // und die geschweiften Klammern und Semikolon sind auch optional
